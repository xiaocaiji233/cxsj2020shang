...
print
'Actual counts:', ac.most_common()
print
'Predicted counts:', pc.most_common()
...
'Accuracy:', accuracy
print
'Manually computed accuracy:', accuracy_manual
...
'Precision:', precision
print
'Manually computed precision:', precision_manual
...
'Recall:', recall
print
'Manually computed recall:', recall_manual
...
'F1 score:', f1_score
print
'Manually computed F1 score:', f1_score_manual